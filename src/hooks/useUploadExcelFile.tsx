    ...
    reader.onload = (event) => {
      ...
      const excel_data = sheetData?.map((item: any) => {
        return {
          ...
          partition_wall_structure: item["PARTITION WALL STRUCTURE"],
          partition_wall_finish: item["PARTITION WALL FINISH"],
          floor_finish: item["FLOOR FINISH"],
          ceiling_finish: item["CEILING FINISH"],
